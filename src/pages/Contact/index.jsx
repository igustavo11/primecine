...
function Contact() {
  ...
  const validateForm = () => {
    ...
    if (!formData.firstName)
      newErrors.firstName = contactData.form.errors.firstName;
    if (!formData.lastName)
      newErrors.lastName = contactData.form.errors.lastName;
    if (!formData.email) {
        ...
        <div className="contact-form">
          <form onSubmit={handleSubmit}>
            ...
            <label>
              ...
              <span>({contactData.form.required})</span>
            </label>
            <input
              type="email"
              name="email"
          ...
          {isSent && (
            <p className="success">{contactData.form.successMessage}</p>
          )}
        </div>
      </div>
    </div>
